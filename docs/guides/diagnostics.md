...
The report checks application paths, database permissions, local-key permissions, `ssh`, `scp`, optional `mosh`, generated configuration, installed include state, and identity-source health.
